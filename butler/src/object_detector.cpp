 ...
 */
ObjectDetector::ObjectDetector() : client_(Action_Server_, true) //action client
{
	/*
 ...
 */
void ObjectDetector::cInfoCallback(const sensor_msgs::CameraInfo& info)
{
	cameraInfo_ = info;
	return;
}
 ...
 */
void ObjectDetector::detectorCallback(const actionlib::SimpleClientGoalState& state,
...
template<typename T> inline T ObjectDetector::mean(const T x, const T y, const T z)
{
 ...
 */
void ObjectDetector::draw(cv_bridge::CvImagePtr& img_, const darknet_ros_msgs::BoundingBox& box_, int counter_)
{
...
*/
void ObjectDetector::reshape(cv::Mat& obj_, const cv_bridge::CvImagePtr& img_, const darknet_ros_msgs::BoundingBox& box_)
{
...
*/
void ObjectDetector::publishXYZ(const darknet_ros_msgs::BoundingBox& box_, double zd)
{
